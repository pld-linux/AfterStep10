...
To jest stara wersja 1.0 zarządcy okien AfterStep. AfterStep jest
kontynuacją BowMan WM. Używa zmodyfikowanego kodu FVWM aby dostarczyć
Ci odczucia podobne do NeXTStepa pod X Window System. To nie wszystko.
AfterStep może być rozszerzony, aby być czymś więcej niż prostym
klonem NeXTStepa.
